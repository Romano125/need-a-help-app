# Generated by Django 2.1.5 on 2019-06-05 12:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('url_to_go_client', models.CharField(default='-', max_length=200)),
                ('url_to_go_sender', models.CharField(default='-', max_length=200)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('seen', models.BooleanField(default=False)),
                ('seen_notif', models.BooleanField(default=False)),
                ('remove', models.BooleanField(default=False)),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reciever', to=settings.AUTH_USER_MODEL)),
                ('message', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='chat.ChatMessage')),
                ('sender', models.ForeignKey(default=False, on_delete=django.db.models.deletion.CASCADE, related_name='sender', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(choices=[('EUR', 'EUR'), ('GBP', 'GBP'), ('AUD', 'AUD (Australian dollar)'), ('USD', 'USD (United States dollar)'), ('CAD', 'CAD (Canadian dollar)'), ('HRK', 'HRK'), ('CZK', 'CZK'), ('HUF', 'HUF'), ('CHF', 'CHF'), ('RON', 'RON'), ('RSD', 'RSD'), ('SEK', 'SEK')], default='EUR', max_length=10)),
